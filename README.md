...
8. Generates one visual per card with GPT Image.
9. Composites and saves final 4:5 PNGs plus the complete post package.
...
8. GPT Image로 카드마다 하나의 배경 이미지를 생성합니다.
9. 텍스트를 합성한 최종 4:5 PNG와 게시 패키지를 함께 저장합니다.
